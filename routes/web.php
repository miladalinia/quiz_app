...
Route::group(['as' => 'client.', 'middleware' => ['auth']], function () {
    ...
    //new updates
    Route::get('profile/{userId}', 'UserController@index')->name('profile.show');
    Route::get('profile/{userId}/edit', 'UserController@edit')->name('profile.edit');
    Route::put('profile/{userId}', 'UserController@update')->name('profile.update');
});
